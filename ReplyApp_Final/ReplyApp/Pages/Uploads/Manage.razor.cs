...
namespace ReplyApp.Pages.Uploads
{
    public partial class Manage
    {
        ...
        /// </summary>
        public ReplyApp.Pages.Uploads.Components.EditorForm EditorFormReference { get; set; }

        /// <summary>
        /// DeleteDialog에 대한 참조: 모달로 항목 삭제하기 
        /// </summary>
        public ReplyApp.Pages.Uploads.Components.DeleteDialog DeleteDialogReference { get; set; }
